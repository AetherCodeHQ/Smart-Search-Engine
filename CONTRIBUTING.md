...
2. Clone your fork: `git clone https://github.com/YOUR_USERNAME/Smart-Search-Engine.git`
...
```bash
# Clone the repo
git clone https://github.com/Qyroxen/Smart-Search-Engine.cd

# Install dependencies
go mod download

# Build
go build -o smartsearchengine .
